...
const MATCHER_SERVICE_URL_RAW =
	process.env.REACT_APP_SCHOLARSHIP_MATCHER_URL ||
	process.env.REACT_APP_SCHOLARSHIP_SERVICE_URL ||
	null;
const MATCHER_SERVICE_URL = MATCHER_SERVICE_URL_RAW
	? MATCHER_SERVICE_URL_RAW.replace(/\/+$/, "")
	: null;
