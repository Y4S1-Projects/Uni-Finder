...
export function NextRoleBadge({
  ...
  return (
    <div className="bg-gradient-to-r from-purple-50 to-blue-50 px-4 py-2.5 rounded-lg border border-purple-200 shadow-sm hover:shadow-md transition-all duration-200">
