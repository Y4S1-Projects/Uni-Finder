		...
		try {
			...
			if (response.ok) {
				...
				try {
					...
					const saveResponse = await fetch(`${BACKEND_API_BASE}/budget/save`, {
						method: "POST",
						headers: {
							"Content-Type": "application/json",
						},
								...
								<div className='summary-box'>
									...
									<div
										className={`summary-value ${
											financial_summary.monthly_savings >= 0 ? "text-success" : "text-danger"
										}`}>
							...
							<Col md={6}>
								...
								{calculated_budgets.food && (
									<div className='mb-3'>
										...
										<small className='text-muted'>
											Type: {calculated_budgets.food.food_type} | Daily: LKR{" "}
											{calculated_budgets.food.daily_cost.toLocaleString()}
										</small>
									</div>
								)}
								{calculated_budgets.transport && (
									<div className='mb-3'>
										...
										<small className='text-muted'>
											Method: {calculated_budgets.transport.transport_method} | Daily: LKR{" "}
											{calculated_budgets.transport.daily_cost.toLocaleString()}
										</small>
