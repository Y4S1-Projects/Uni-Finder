...
const BudgetOptimizer = () => {
  ...
  const fetchModelPerformance = async () => {
    try {
      const response = await fetch(`${backendUrl}/budget/performance`);
      if (response.ok) {
  ...
  const predictExpenses = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/budget/predict`, {
        method: 'POST',
        headers: {
  ...
  const optimizeBudget = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/budget/optimize`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
          ...
          <Col>
            <div className="text-center">
              ...
              <p className="lead text-muted">
                Component 2 of UniFinder LK Platform | Designed for Sri Lankan Students
              </p>
              ...
              <Card.Body className="p-4">
                <Form>
                  <Row>
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        <Form.Label><strong>Current Semester</strong></Form.Label>
                  ...
                  <Row>
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        <Form.Label><strong>Degree Type</strong></Form.Label>
                  ...
                  <Form.Group className="mb-4">
                    <Form.Label><strong>Target Savings Rate (%)</strong></Form.Label>
                    <Form.Control
                      type="number"
                ...
                <Card.Body>
                  <div className="result-metric">
                    <div className="d-flex justify-content-between align-items-center py-2 border-bottom">
                      <span><strong>Predicted Monthly Expenses:</strong></span>
              ...
              <Card className="shadow-lg border-0 mb-4">
                ...
                <Card.Body>
                  <div className="result-metric mb-3">
                    <div className="d-flex justify-content-between align-items-center py-2 border-bottom">
                      <span><strong>Total Optimized Expenses:</strong></span>
                      <span className="fs-4 fw-bold text-success">
                        LKR {optimizationResult.total_expenses?.toLocaleString()}
                      </span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center py-2 border-bottom">
                      <span><strong>Projected Savings:</strong></span>
                      <span className="fs-4 fw-bold text-success">
                  ...
                  {optimizationResult.optimized_budget && Object.entries(optimizationResult.optimized_budget).map(([category, amount]) => {
                    ...
                    return (
                      <div key={category} className="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <span className="fw-bold">LKR {amount?.toLocaleString()} ({percentage}%)</span>
                      </div>
                    );
                  })}
                </Card.Body>
